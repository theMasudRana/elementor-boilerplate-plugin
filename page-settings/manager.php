<?php
namespace ElementorBoilerplatePlugin\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'elementor-boilerplate-plugin' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'elementor-boilerplate-plugin' ),
				'tab'   => self::PANEL_TAB,
			]
		);
